...
main()
{
    ...
    int changeCoin5Cnt = 0;
    int curChangeCoin5Cnt = 0;
    int extraCoin5Cnt = 0;
    ...
    for (int i = 0; i < N; ++i) {
        ...
        curChangeCoin5Cnt = (coin - 5) / 5;

        changeCoin5Cnt += (curChangeCoin5Cnt - extraCoin5Cnt > 0) *
        	(curChangeCoin5Cnt - extraCoin5Cnt);

        extraCoin5Cnt -= (extraCoin5Cnt > 0) *
        (curChangeCoin5Cnt < extraCoin5Cnt ? curChangeCoin5Cnt : extraCoin5Cnt);

        extraCoin5Cnt += (coin == 5);
    }

    printf("%d\n", (changeCoin5Cnt > 0 ? changeCoin5Cnt : 0));
